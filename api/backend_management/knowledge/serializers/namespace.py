...
class NamespaceCollaboratorSerializer(serializers.ModelSerializer):
    """
    知识库协作者序列化器
    """
...
class NamespaceSerializer(serializers.ModelSerializer):
    ...
    collaborators = NamespaceCollaboratorSerializer(many=True, read_only=True)
    ...
    class Meta:
        model = Namespace
        fields = [
            'id', 'name', 'description', 'cover', 'access_type', 'creator', 
            'slug', 'is_active', 'created_at', 'updated_at', 'collaborators',
...
class NamespaceListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'description', 'cover', 'access_type', 'creator',
            'slug', 'is_active', 'created_at', 'updated_at', 'collaborator_count',
            'is_public', 'can_access', 'can_edit'
        ]
...
class AddCollaboratorSerializer(serializers.Serializer):
    ...
    role = serializers.ChoiceField(
        choices=NamespaceCollaborator.ROLE_CHOICES,
        required=False,
...
class NamespaceBasicUpdateSerializer(serializers.ModelSerializer):
    """
    知识库基本信息更新序列化器
    """
    ...
    class Meta:
        model = Namespace
        fields = ['name', 'description', 'cover', 'access_type'] 